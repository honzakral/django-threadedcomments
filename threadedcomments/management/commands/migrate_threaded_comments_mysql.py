...
SELECT
    ...
    is_approved,
    ip_address
FROM threadedcomments_threadedcomment ORDER BY date_submitted ASC
"""
...
SELECT
    ...
    is_approved,
    ip_address
FROM threadedcomments_freethreadedcomment ORDER BY date_submitted ASC
"""
