...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'ThreadedComment', fields ['tree_path']
        if connection.vendor == 'mysql':
            db.execute('DROP INDEX threadedcomments_comment_tree_path ON threadedcomments_comment')
        else:
            db.delete_index('threadedcomments_comment', ['tree_path'])
