...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ThreadedComment.tree_path'
        db.alter_column('threadedcomments_comment', 'tree_path', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'ThreadedComment.tree_path'
        pass
        #db.alter_column('threadedcomments_comment', 'tree_path', self.gf('django.db.models.fields.TextField')())
